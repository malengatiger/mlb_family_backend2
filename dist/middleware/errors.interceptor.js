...
exports.KasieError = exports.ErrorsInterceptor = void 0;
...
let ErrorsInterceptor = class ErrorsInterceptor {
    intercept(context, next) {
        ...
        function handleError(err) {
            ...
            return (0, rxjs_1.throwError)(() => new KasieError(common_1.HttpStatus.BAD_REQUEST, `😈😈 ${err.message}`, `${next.handle.name}`));
        }
    }
};
